...
class SmsContentTest < ActiveSupport::TestCase
  ...
  test "booking enquiry with an integer cost" do
    ...
    assert_equal "Job: 20 March 14:00 - 18:00 (cleaning stuff provided). Will pay 48 pounds. Accept? Reply 'yes' or 'no' before 22:12", SmsContent.booking_enquiry(booking)
  end
  ...
  test "booking enquiry with a non-integer cost" do
    ...
    SmsContent.stubs(:booking_reply_deadline).returns '22:12'
    assert_equal "Job: 20 March 14:00 - 18:00 (cleaning stuff provided). Will pay 53.20 pounds. Accept? Reply 'yes' or 'no' before 22:12", SmsContent.booking_enquiry(booking)
  end
